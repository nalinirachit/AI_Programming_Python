...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open (dogfile, 'r') as aFile:
        # read in dognames from first line
        oneLine = aFile.readline()
        ...
        while oneLine != "":
            ...
            if oneLine not in dognames_dic:
                dognames_dic[oneLine] = 1
            else:
                print('***Name already existsin dognames_dic:', oneLine )
            
            # Reads in next line in file to be processed with while loop
            # if this line isn't empty (EOF)
            oneLine = aFile.readline()
    # removing testing      
    # print('Dogfile dict: ', dognames_dic)
    ...
    for key in results_dic:
        #dictionary extend not working without this list
        new_list_to_add = []
