...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print("/n/n Results Summary for CNN Model Architecture", model.upper(),"***" )
    ...
    for key in results_stats_dic:
        ...
        sKey = key
        if sKey[0] == "p":
            print("{:20}: {:30}".format(key, round(results_stats_dic[key], 2)))
    ...
    if (print_incorrect_dogs and 
            ...
            for key in results_dic:
                if (results_dic[key][3] == 1 and results_dic[key][4] == 0) or (results_dic[key][3] == 0 and results_dic[key][4] == 1):
                    print("{:20}: {:20}: {:30}:".format("Pet/Classifier labels not matching", results_dic[key][0], results_dic[key][1]))
