...
def calculates_results_stats(results_dic):
    ...
    # number of total dog images
    results_stats_dic['n_dogs_img'] = 0
    # number of correct dog matches, the classifier and pet labels match
    ...
    for key in results_dic:
        ...
        # if pet and classifier labels match:
        ...
        # classifier and pet label match: Index2 = 1 and Index3 = 1
    ...
    # adding check by division by zero 
    if (results_stats_dic['n_dogs_img']) > 0:
